...
const ReportManagementForm = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                setIsSave(true)
                await ReportService.responseReport(id!, { statusComment: values.statusComment })
    ...
    return (
        <Box width={'100%'} display={'flex'} flexDirection={'column'} gap={"16px"}>
            ...
            <Box sx={{
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', width: '95%', justifyContent: 'center' }}>
                        ...
                        <Table>
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell sx={{ border: '1px solid #e0e0e0', padding: '8px' }}>
                                        <Typography fontSize={isMobile ? "16px" : "20px"} fontWeight={400} variant="h5">{report?.category.categoryName}</Typography>
                                    </TableCell>
                                </TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell sx={{ border: '1px solid #e0e0e0', padding: '8px' }}>
                                        <Typography fontSize={isMobile ? "16px" : "20px"} fontWeight={400} variant="h5">{report?.reporter.name}</Typography>
                                    </TableCell>
                                </TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell sx={{ border: '1px solid #e0e0e0', padding: '8px' }}>
                                        <Typography fontSize={isMobile ? "16px" : "20px"} fontWeight={400} variant="h5">{new Date(report?.createDatetime || "").toLocaleDateString()}</Typography>
                                    </TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={{ border: '1px solid #e0e0e0', padding: '8px' }}>
                                    ...
                                    <TableCell sx={{ border: '1px solid #e0e0e0', padding: '8px' }}>
                                        <Typography fontSize={isMobile ? "16px" : "20px"} fontWeight={400} variant="h5">{report?.detail}</Typography>
                                    </TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
