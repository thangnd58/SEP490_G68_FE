...
export const DashboardManagement = () => {
  ...
  const sortedMoneyOutValues = dataEntries.map(
    ([_, data]: any) => data.moneyOut
  );
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      endDate: Yup.string().required(
        t("postMotorbike.registedForm.endDateRequired")
      ),
    }),
          ...
          >
            ...
            <Box width={isMobile ? "100%" : "27%"}>
              <Box display={"flex"} width={"100%"} pb={"8px"}>
                <Typography color={"#666666"} width={"50%"} fontWeight={"bold"}>
                  {t("dashBoardManager.dashboard.startDate")}
                </Typography>
                <Typography color={"#666666"} width={"50%"} fontWeight={"bold"}>
                  {t("dashBoardManager.dashboard.endDate")}
                </Typography>
              </Box>
              <RangePicker
            ...
            <Box width={isMobile ? "100%" : "70%"}>
              ...
              >
                <MyCustomButton
                  ...
                  onClick={() =>
                    navigate(ROUTES.admin.dashboardStatistic.moneyInDetail)
                  }
                  width="30%"
                  variant="outlined"
                  borderColor="rgba(75,192,192,1)"
                ...
                <MyCustomButton
                  ...
                  onClick={() =>
                    navigate(ROUTES.admin.dashboardStatistic.moneyOutDetail)
                  }
                  width="30%"
                  variant="outlined"
                  borderColor="#bb3bbb"
                ...
                <MyCustomButton
                  ...
                  onClick={() =>
                    navigate(ROUTES.admin.dashboardStatistic.revenueDetail)
                  }
                  width="30%"
                  variant="outlined"
                  borderColor="#42a753"
