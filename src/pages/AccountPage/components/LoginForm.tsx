...
const FormStyleModal = styled('form')(({ theme }) => ({
  width: '100%',
  display: 'flex',
  flexDirection: 'column',
  justifyContent: 'center',
...
const LoginForm = (props: { isModal?: boolean, isMobileModal?: boolean, setIsOpenLoginModal?: React.Dispatch<React.SetStateAction<boolean>> }) => {
  ...
  return (
    ...
    <>{isModal ?
      (
        <FormStyleModal className='form' onSubmit={handleSubmit}>
          <Paper elevation={3} sx={{
            ...
            <Box className='login-form'>
              <Box className="login-form-content" sx={{ width: isMobile ? "100%" : "80%" }}>
                ...
                <Box className='save-account-forgot-password' flexDirection={isMobileModal ?"column" : "row"} alignItems={isMobileModal ?"start" : "center"}>
                ...
                <Box className='login-hint' flexDirection={isMobileModal ?"column" : "row"}>
                  <Typography>
                    {t("form.login_hint")}
                  </Typography>
        ...
        <FormStyle className='form' onSubmit={handleSubmit}>
          <Paper elevation={3} sx={{ width: isModal ? "70%" : isMobile ? '75%' : '30%' }}>
            <Typography className='login'>
              {t("form.login")}
            </Typography>
            <Box className='login-form'>
