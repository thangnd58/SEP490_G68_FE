...
function SearchingHotProvince() {
    ...
    const chooseImage = (province: string) => {
        switch (province) {
            case "Hà Nội":
                return ImageProvince[0];
            case "TP.HCM":
                return ImageProvince[1];
            case "Đà Nẵng":
                return ImageProvince[2];
            case "Hải Phòng":
                return ImageProvince[3];
            case "Ninh Bình":
                return ImageProvince[4];
            case "Hà Giang":
...
export default SearchingHotProvince