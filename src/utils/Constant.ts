...
export const BASE_URL =
  "https://hzuzmhgcmt.ap-southeast-1.awsapprunner.com/api";
export const SERVER_HUB_URL =
  "https://hzuzmhgcmt.ap-southeast-1.awsapprunner.com/customhub";
export const ROUTES = {
  homepage: "/",
  newspage: "/news",
...
export const MoneyFlowType = {
  BookingPaymentByUserBalance: "BookingPaymentByUserBalance",
  BookingPaymentByVNPay: "BookingPaymentByVNPay",
  RefundWhenCancelBooking: "RefundWhenCancelBooking",
  ToDeposite: "ToDeposite",
  ToPayDepositForMotorbikeOwner: "ToPayDepositForMotorbikeOwner",
  ToPayDepositWithVNPay: "ToPayDepositWithVNPay",
  ToPayDepositWithWallet: "ToPayDepositWithWallet",
